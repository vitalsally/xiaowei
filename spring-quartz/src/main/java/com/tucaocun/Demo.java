...
//    	Map<String, Object> request2 = getRequest2();
//    	JSONArray array = (JSONArray)request2.get("result");
//    	for(int i=0;i<array.size();i++){
//    		System.out.println(array.get(i));
//    		String title = (String)array.get(i);
//    		NewService newService =(NewService) GetBeanFactory.getSpringEntry("newService");
...
//    	System.out.println(new Gson().toJson(request2));
//    	Collection.toArray();
...
//    	JSONArray jsonarray = JSONArray.fromObject();
    	...
    	Map<String, Object> request1 = getRequest1("杨洋珠绣西装亮相");
    	JSONArray array = (JSONArray)request1.get("result");
    	for (int i = 0; i < array.size(); i++) {
    		JSONObject jsonObject = (JSONObject) array.get(i);
    		System.out.println(jsonObject.get("full_title"));
			
		}
    	System.out.println(new GsonBuilder().setPrettyPrinting().create().toJson(request1.get("result")));
